...
import { appendUnconfirmedBid, closeMenu } from '../../actions'
...
class BidParcelModalContainer extends React.Component {
  ...
  onBid = value => {
    const { data, appendUnconfirmedBid, addressState, onClose, closeMenu } = this.props
    const parcel = data
...
export default connect(
  ...
  { appendUnconfirmedBid, closeMenu }
